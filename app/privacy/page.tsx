...
export default function PrivacyPage() {
  return (
    <article className="prose prose-invert mx-auto max-w-2xl space-y-5 text-sm leading-relaxed text-zinc-300">
      <h1 className="text-2xl font-extrabold text-zinc-100">Privacy</h1>
      <p>
      ...
      <h2 className="text-lg font-bold text-zinc-100">What we read from Google</h2>
      <p>
      ...
      <h2 className="text-lg font-bold text-zinc-100">What we store</h2>
      <p>
      ...
      <h2 className="text-lg font-bold text-zinc-100">What friends can see</h2>
      ...
      <h2 className="text-lg font-bold text-zinc-100">Deleting your data</h2>
      <p>
      ...
      <h2 className="text-lg font-bold text-zinc-100">A note on health data</h2>
      <p>
